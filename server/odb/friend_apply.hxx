...
namespace IM
{
    ...
    public:
        ...
        FriendApply(const std::string& event_id,
        ...
        std::string eventId() const { return _event_id; }
        void eventId(const std::string& event_id) { _event_id = event_id; }
