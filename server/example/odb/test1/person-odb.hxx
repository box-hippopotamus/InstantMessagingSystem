...
namespace odb
{
  ...
  struct query_columns< ::Person, id_mysql, A >
  {
    ...
    static const math_score_type_ math_score;
    ...
    static const english_score_type_ english_score;
  };
  ...
  template <typename A>
  const typename query_columns< ::Person, id_mysql, A >::math_score_type_
  query_columns< ::Person, id_mysql, A >::
  math_score (A::table_name, "`math_score`", 0);

  template <typename A>
  const typename query_columns< ::Person, id_mysql, A >::english_score_type_
  query_columns< ::Person, id_mysql, A >::
  english_score (A::table_name, "`english_score`", 0);
    ...
    public access::object_traits< ::Person >
  {
    ...
    struct image_type
    {
      ...
      // _math_score
      //
      details::buffer _math_score_value;
      unsigned long _math_score_size;
      my_bool _math_score_null;

      // _english_score
      //
      details::buffer _english_score_value;
      unsigned long _english_score_size;
      my_bool _english_score_null;
